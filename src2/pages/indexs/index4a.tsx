...
function Profile({back, insertText, coffee} : {back : Dispatch<SetStateAction<number>>, insertText : (str : string)=>void, coffee : Product}){
  ...
  return (
    <div>
      {profile === -1 ? (    
        ...
        <Profile back={setProfile} insertText={insertText} coffee={profileCoffee}></Profile>
        )
     }
    </div>
)}